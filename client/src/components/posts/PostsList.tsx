    ...
    return (
        <div className="pb-20 md:pb-10">
            <div className="flex justify-between items-center mb-6">
                ...
                <Link
                    href="/posts/create"
                    className="flex items-center space-x-1 px-4 py-2 bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-full hover:opacity-90 shadow-sm"
                >
                    ...
                    {pagination.pages > 1 && (
                        <div className="mt-8">
                            <button
                                ...
                                className="w-full p-3 bg-white dark:bg-gray-800 text-pink-500 font-medium text-center rounded-xl border border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
